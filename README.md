...
- **4824 automated tests** with 78.7% code coverage
...
safe_update.py continue    →  pytest (all 4824 tests) → mypy → merge → restart bot → quality tests → publish
```
