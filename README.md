...
- **6200 automated tests** with 83.9% code coverage
...
safe_update.py continue    →  pytest (all 6200 tests) → mypy → merge → restart bot → quality tests → publish
````
