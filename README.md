...
- **6152 automated tests** with 83.7% code coverage
...
safe_update.py continue    →  pytest (all 6152 tests) → mypy → merge → restart bot → quality tests → publish
````
