...
- **6189 automated tests** with 83.9% code coverage
- **104 Python modules** across 43,189 lines of code
...
| Idea Board | `idea_board/web.py`, `idea_board/models.py`, `idea_board/executor.py`, `idea_board/jira_sync.py`, `idea_board/jira_sync_dlq.py` |
...
safe_update.py continue    →  pytest (all 6189 tests) → mypy → merge → restart bot → quality tests → publish
````
