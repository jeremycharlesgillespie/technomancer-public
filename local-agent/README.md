...
- **5711 automated tests** with 0% code coverage
...
safe_update.py continue    →  pytest (all 5711 tests) → mypy → merge → restart bot → quality tests → publish
```
