...
- **3768 automated tests** with 78.7% code coverage
...
safe_update.py continue    →  pytest (all 3768 tests) → mypy → merge → restart bot → quality tests → publish
```
